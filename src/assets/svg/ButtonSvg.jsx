const ButtonSvg = (black) => (
  <>
    ...
    >
      <path
        fill={black ? "black" : "none"}
        stroke={black ? "black" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={black ? "black" : "none"}
        stroke={black ? "black" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
